...
<html lang="zxx">  
    <head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Our Services - Hire Course Help.Com</title>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                ...
                <div class="breadcrumbs-text white-color">
                    <h1 class="page-title">We Do Online Exam Help</h1>
                    <ul>
                        <li>
                            <a class="active" href="https://hirecoursehelp.com/">Home</a>
                        </li>
                        <li>
                            <a class="active" href="Our-Services">Our Services</a>
                        </li>
                        <li>
                            Service 04
                        </li>
					...
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								...
								<div class="free-course-contact" style="background: rgba(245, 245, 245, 1);">
                                <span class="mb-20" style="color: #505050;">SignUp & Get 40% Discount </span>
						...
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								<div class="sub-title orange">About Online Exam Help</div>
								<h2 class="title mb-17">Can You Take My Exam For Me ?</h2>
								<div class="bold-text mb-22">Can You Take My Online Exam For Me? Yes you are at the right place,</div>
								<div class="desc">There are numerous reasons to choose us, the first of which is our impossibly low prices.Other firms will almost certainly be unable to match these prices.In addition, we offer a number of complimentary services, including various free revisions and a plagiarism report.If that isn't enough to convince you.</div>
							</div>
						</div>
					</div>
				</div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 pl-100 md-pl-15 col-md-12">
                            <div class="content">
                                ...
                                <h2 class="sl-title mb-40 md-mb-20">Can Someone Else Take My Exam And Score Better Than Me? Hell, Yeah!</h2>
                                <p class="desc mb-50">
                                   hirecoursehelp.com realizes how difficult it is to prepare for exams at the last minute. You pay alot for a course and getting stuck is not an option. Therefore, it is best to assist a little. We make sure that our experts, who are the best by the way, take your exam and get you your desired result.You must be thinking about how it will go about and whether it will work or not. We understand. Don’t panic, we got your back. Get in touch with us and one of our skilled representatives will guide you through every little detail.
					...
					<div class="rs-carousel owl-carousel nav-style2 orange-color" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="true" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="true" data-md-device-dots="false">
						<div class="team-item">
							...
							<div class="content-part">
								<h4 class="name"><a href="team-single">Jhon Pedrocas</a></h4>
						...
						<div class="team-item">
							...
							<div class="content-part">
								<h4 class="name"><a href="team-single">Jesika Albenian</a></h4>
								<span class="designation">Professor</span>
								<ul class="social-links">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
						...
						<div class="team-item">
							...
							<div class="content-part">
								<h4 class="name"><a href="team-single">Alex Anthony</a></h4>
								<span class="designation">Professor</span>
								<ul class="social-links">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
