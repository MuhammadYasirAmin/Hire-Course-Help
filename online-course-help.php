...
<html lang="zxx">  
    <head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Our Services - HireCourseHelp.Com</title>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                ...
                <div class="breadcrumbs-text white-color">
                    <h1 class="page-title">We Take Online Quizez & Assignments</h1>
                    <ul>
                        <li>
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								<div class="sub-title orange">About Online Quizez and Assignments</div>
								<h2 class="title mb-17">Want Us To assist Your Online Classes?</h2>
								...
								<div class="desc">If you are looking for someone who can take care of your burden and do your homework for you, then you are at the right place. We – hirecoursehelp.com – provide robust packages and services to students all around the globe to help them cope up with their studies given the conditions we live in.</div>
							</div>
						</div>
					</div>
				</div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12 md-mb-40">
                           <div class="img-part js-tilt">
                               <img src="assets/images/about/about2.png" alt="images">
                           </div>
                        </div>
                        <div class="col-lg-6 pl-100 md-pl-15 col-md-12">
                            <div class="content">
                                ...
                                <h2 class="sl-title mb-40 md-mb-20">Ease Into Your Online Classes</h2>
                                <p class="desc mb-50">
                                   Our team is headed by people who have firsthand experience with student responsibilities.Our academic experts have previously served in your position and have completed their academic responsibilities. You can only benefit from their assistance because professional assistance can never hurt.We provide high-quality, dependable, and affordable services to make your life easier.
                                </p>
                            </div>
                              <div class="btn-part">
